...
export const recipes: Recipe[] = [
  ...
  {
    id: "star-sandwich",
    name: "⭐ Sándwich Estrella",
    image: imgStarSandwich,
    emoji: "⭐",
    color: "kids-yellow",
    category: "snacks",
    difficulty: 2,
  ...
  {
    id: "banana-rolls",
    name: "🍌 Rollitos de Plátano",
    image: imgBananaRolls,
    emoji: "🍌",
    color: "kids-yellow",
    category: "snacks",
    difficulty: 1,
  ...
  {
    id: "tomato-ladybugs",
    name: "🐞 Mariquitas de Tomate",
    image: imgTomatoLadybugs,
    emoji: "🐞",
    color: "kids-red",
    category: "snacks",
    difficulty: 1,
    ingredients: [
      { emoji: "🍘", quantity: 4, grams: 40 },
      { emoji: "🧀", quantity: 1, grams: 30 },
      { emoji: "🍅", quantity: 4, grams: 60 },
      { emoji: "🫒", quantity: 4, grams: 10 },
    ],
    steps: [
      { emoji: "🧀", ingredientEmojis: ["🍘", "🧀"], actionIcon: "spread" },
      { emoji: "🍅", ingredientEmojis: ["🍅"], actionIcon: "place" },
  ...
  {
    id: "broccoli-forest",
    name: "🌳 Bosque de Brócoli",
    image: imgBroccoliForest,
    emoji: "🌳",
    color: "kids-green",
    category: "meals",
    difficulty: 2,
  ...
  },
  {
    ...
    difficulty: 1,
    ingredients: [
      { emoji: "🍇", quantity: 6, grams: 30 },
      { emoji: "🍌", quantity: 1, grams: 100 },
      { emoji: "🍓", quantity: 2, grams: 30 },
      { emoji: "🥛", quantity: 1, grams: 80 },
      { emoji: "🫐", quantity: 4, grams: 4 },
    ],
    steps: [
      { emoji: "🥛", ingredientEmojis: ["🥛"], actionIcon: "scoop" },
      { emoji: "🍇", ingredientEmojis: ["🍇", "🍓", "🍌"], actionIcon: "place" },
  ...
  {
    id: "banana-sushi",
    name: "🍣 Sushi de Plátano",
    image: imgBananaSushi,
    emoji: "🍣",
    color: "kids-purple",
    category: "desserts",
    difficulty: 2,
  ...
  {
    id: "chickpea-burgers",
    name: "🍔 Mini Hamburguesas de Garbanzo",
    image: imgChickpeaBurgers,
    emoji: "🍔",
    color: "kids-orange",
    category: "meals",
    difficulty: 3,
  ...
  {
    id: "rainbow-sticks",
    name: "🌈 Palitos Arcoíris",
    image: imgRainbowSticks,
    emoji: "🌈",
    color: "kids-orange",
    category: "snacks",
    difficulty: 1,
  ...
  {
    id: "smile-empanadas",
    name: "😀 Empanadillas Sonrisa",
    image: imgSmileEmpanadas,
    emoji: "😀",
    color: "kids-yellow",
    category: "meals",
    difficulty: 3,
  ...
  {
    id: "watermelon-pops",
    name: "🍉 Piruletas de Sandía",
    image: imgWatermelonPops,
    emoji: "🍉",
    color: "kids-red",
    category: "fruits",
    difficulty: 2,
  ...
  {
    id: "veggie-train",
    name: "🚂 Tren de Verduras",
    image: imgVeggieTrain,
    emoji: "🚂",
    color: "kids-green",
    category: "snacks",
    difficulty: 2,
