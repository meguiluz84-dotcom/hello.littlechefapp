...
export const recipes: Recipe[] = [
  ...
  {
    id: "chef-mini-calzones",
    name: "👨‍🍳 Mini Calzones Arcoíris",
    image: imgEmpanadas,
    emoji: "🌈",
    color: "kids-red",
    category: "meals",
    ...
    steps: [
      { emoji: "🫓", ingredientEmojis: ["🌾"], actionIcon: "spread" },
      { emoji: "🍅", ingredientEmojis: ["🍅"], actionIcon: "spread", quantity: "1 cuchara" },
      { emoji: "🧀", ingredientEmojis: ["🧀"], actionIcon: "place", quantity: "1 taza" },
      { emoji: "🌈", ingredientEmojis: ["🌽", "🥬", "🫑"], actionIcon: "place" },
      { emoji: "🥟", ingredientEmojis: [], actionIcon: "mix" },
      { emoji: "🍴", ingredientEmojis: [], actionIcon: "shake" },
      { emoji: "🔥", ingredientEmojis: [], actionIcon: "bake", adultRequired: true, timerSeconds: 900 },
  ...
  {
    id: "chef-nuggets-garbanzo",
    name: "👨‍🍳 Nuggets de Garbanzo",
    image: imgChickpeaBurgers,
    emoji: "🟡",
    color: "kids-orange",
    category: "meals",
    ...
    steps: [
      { emoji: "🫘", ingredientEmojis: ["🫘"], actionIcon: "mix", quantity: "1 taza" },
      { emoji: "🥕", ingredientEmojis: ["🥕"], actionIcon: "place" },
      { emoji: "🌾", ingredientEmojis: ["🌾"], actionIcon: "pour", quantity: "media taza" },
      { emoji: "🌀", ingredientEmojis: [], actionIcon: "mix" },
      { emoji: "🤲", ingredientEmojis: [], actionIcon: "scoop" },
      { emoji: "🥄", ingredientEmojis: [], actionIcon: "place" },
      { emoji: "🔥", ingredientEmojis: ["🫒"], actionIcon: "bake", adultRequired: true, timerSeconds: 900 },
      { emoji: "⏲️", ingredientEmojis: [], actionIcon: "wait", timerSeconds: 120 },
    ],
  },
  {
    id: "chef-sushi-vegetal",
    name: "👨‍🍳 Sushi Vegetal Fácil",
    image: imgBananaSushi,
    emoji: "🍣",
    color: "kids-green",
    category: "meals",
    ...
    steps: [
      { emoji: "🍚", ingredientEmojis: ["🍚"], actionIcon: "spread", quantity: "1 taza" },
      { emoji: "🥒", ingredientEmojis: ["🥒", "🥕"], actionIcon: "place" },
      { emoji: "🧀", ingredientEmojis: ["🧀"], actionIcon: "spread", quantity: "1 cuchara" },
      { emoji: "🌯", ingredientEmojis: [], actionIcon: "mix" },
      { emoji: "🤲", ingredientEmojis: [], actionIcon: "shake" },
  ...
  },
  {
    ...
    steps: [
      { emoji: "🌾", ingredientEmojis: ["🌾"], actionIcon: "pour", quantity: "1 taza" },
      { emoji: "🥚", ingredientEmojis: ["🥚"], actionIcon: "mix", adultRequired: true },
      { emoji: "🥛", ingredientEmojis: ["🥛"], actionIcon: "pour", quantity: "media taza" },
      { emoji: "🌀", ingredientEmojis: ["🫒"], actionIcon: "mix" },
      { emoji: "🧀", ingredientEmojis: ["🧀", "🥬"], actionIcon: "place" },
      { emoji: "🧁", ingredientEmojis: [], actionIcon: "scoop" },
      { emoji: "🔥", ingredientEmojis: [], actionIcon: "bake", adultRequired: true, timerSeconds: 1200 },
      { emoji: "❄️", ingredientEmojis: [], actionIcon: "chill", timerSeconds: 300 },
    ],
  },
  {
    id: "chef-hamburguesitas-lentejas",
    name: "👨‍🍳 Hamburguesitas de Lentejas",
    image: imgChickpeaBurgers,
    emoji: "🍔",
    color: "kids-red",
    category: "meals",
  ...
  },
  {
    ...
    steps: [
      { emoji: "🫓", ingredientEmojis: ["🌾"], actionIcon: "spread" },
      { emoji: "🍅", ingredientEmojis: ["🍅"], actionIcon: "spread", quantity: "media taza" },
      { emoji: "🧀", ingredientEmojis: ["🧀", "🥬"], actionIcon: "place", quantity: "1 taza" },
      { emoji: "🔪", ingredientEmojis: [], actionIcon: "cut", adultRequired: true },
      { emoji: "🎀", ingredientEmojis: [], actionIcon: "mix" },
      { emoji: "🫒", ingredientEmojis: ["🫒"], actionIcon: "spread", quantity: "1 cuchara" },
      { emoji: "🔥", ingredientEmojis: [], actionIcon: "bake", adultRequired: true, timerSeconds: 900 },
      { emoji: "❄️", ingredientEmojis: [], actionIcon: "chill", timerSeconds: 180 },
    ],
  },
  {
    id: "chef-rollitos-primavera",
    name: "👨‍🍳 Rollitos de Primavera Fríos",
    image: imgSnakeWrap,
    emoji: "🌯",
    color: "kids-green",
    category: "meals",
    ...
    steps: [
      { emoji: "💧", ingredientEmojis: ["🫓"], actionIcon: "wash" },
      { emoji: "🥕", ingredientEmojis: ["🥕", "🥒"], actionIcon: "place", quantity: "media taza" },
      { emoji: "🥑", ingredientEmojis: ["🥑"], actionIcon: "place" },
      { emoji: "🤲", ingredientEmojis: [], actionIcon: "spread" },
      { emoji: "🌯", ingredientEmojis: [], actionIcon: "mix" },
      { emoji: "🔪", ingredientEmojis: [], actionIcon: "cut", adultRequired: true },
  ...
  {
    id: "chef-gnocchi-boniato",
    name: "👨‍🍳 Gnocchi de Boniato",
    image: imgRiceBalls,
    emoji: "🍠",
    color: "kids-orange",
    category: "meals",
    ...
    steps: [
      ...
      { emoji: "🤲", ingredientEmojis: [], actionIcon: "spread" },
      { emoji: "🔪", ingredientEmojis: [], actionIcon: "cut", adultRequired: true },
      { emoji: "🔥", ingredientEmojis: [], actionIcon: "bake", adultRequired: true, timerSeconds: 240 },
      { emoji: "🍅", ingredientEmojis: ["🍅"], actionIcon: "pour" },
      { emoji: "🎉", ingredientEmojis: [], actionIcon: "shake" },
    ],
  },
  {
    id: "chef-smile-empanadas",
    name: "👨‍🍳 Empanadillas Sonrisa",
    image: imgSmileEmpanadas,
    emoji: "😀",
    color: "kids-yellow",
    ...
    medalId: "chef-avanzado",
    ingredients: [
      { emoji: "🌾", quantity: 4, grams: 80 },
      { emoji: "🧀", quantityLabel: "media taza" },
      { emoji: "🍅", quantityLabel: "1 cuchara" },
      { emoji: "🥚", quantity: 1 },
    ],
    steps: [
      { emoji: "🥄", ingredientEmojis: ["🧀"], actionIcon: "scoop", quantity: "media taza" },
      { emoji: "🥟", ingredientEmojis: ["🌾"], actionIcon: "mix" },
      { emoji: "🍴", ingredientEmojis: [], actionIcon: "shake" },
      { emoji: "😀", ingredientEmojis: [], actionIcon: "spread" },
      { emoji: "🥚", ingredientEmojis: ["🥚"], actionIcon: "spread", adultRequired: true },
      { emoji: "🔥", ingredientEmojis: [], actionIcon: "bake", adultRequired: true, timerSeconds: 900 },
      { emoji: "⏲️", ingredientEmojis: [], actionIcon: "wait", timerSeconds: 120 },
      { emoji: "🍽️", ingredientEmojis: ["🍅"], actionIcon: "place", quantity: "1 cuchara" },
    ],
  },
  {
    id: "chef-bizcochitos-zanahoria",
    name: "👨‍🍳 Bizcochitos de Zanahoria",
    image: imgGalletasCacao,
    emoji: "🥕",
    color: "kids-orange",
    category: "desserts",
    ...
    steps: [
      ...
      { emoji: "🥕", ingredientEmojis: ["🥕"], actionIcon: "place", quantity: "media taza" },
      { emoji: "🥛", ingredientEmojis: ["🥛", "🥚"], actionIcon: "pour" },
      { emoji: "🌀", ingredientEmojis: ["🫒"], actionIcon: "mix", quantity: "1 cuchara" },
      { emoji: "🧁", ingredientEmojis: [], actionIcon: "scoop" },
      { emoji: "🔥", ingredientEmojis: [], actionIcon: "bake", adultRequired: true, timerSeconds: 1500 },
      { emoji: "❄️", ingredientEmojis: [], actionIcon: "chill", timerSeconds: 300 },
      { emoji: "🏅", ingredientEmojis: [], actionIcon: "place" },
    ],
  },
