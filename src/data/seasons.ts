...
const RECIPE_SEASONS: Record<string, Season[]> = {
  ...
  "star-sandwich":  ["primavera"],
  "banana-rolls":   ["otono", "invierno"],
  "tomato-ladybugs": ["primavera", "verano"],
  "broccoli-forest": ["otono", "invierno"],
  "egg-boats":      ["primavera"],
  "snail-rolls":    ["primavera"],
  "butterfly-pizza": ["primavera", "verano"],
  "fruit-worm":     ["primavera", "verano"],
  "rice-clouds":    ["invierno"],
  "garden-toast":   ["primavera"],
  "banana-sushi":   ["otono"],
  "chickpea-burgers": ["otono", "invierno"],
  "rainbow-sticks": ["primavera", "verano"],
  "green-pancakes": ["invierno"],
  "moon-bowl":      ["otono", "invierno"],
  "smile-empanadas": ["otono", "invierno"],
  "mini-tacos":     ["verano"],
  "apple-donut":    ["otono"],
  "watermelon-pops": ["verano"],
  "veggie-train":   ["primavera", "verano"],
};
